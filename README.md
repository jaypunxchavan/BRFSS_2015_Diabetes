...
## Data
- `diabetes_binary_health_indicators_BRFSS2015.csv`: curated BRFSS 2015 dataset used for the primary analysis.
- `LLCP2020.XPT`: BRFSS 2020 raw data file used for external validation.
## Usage
